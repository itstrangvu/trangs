...
Here are my notes on what I learned during my first year at Similarweb while designing product features. 
...
Oh, yeah, if you're testing with a PPC manager, the prototype should run on data relevant to that PPC manager. Testing them on a rival's numbers tells you nothing. 
